...
const checklistFuncRe = /  const handleUpdateChecklist = \([\s\S]*?  };\n/m;
const newChecklistFunc = `  const handleUpdateChecklist = (
    choreId: string, 
...
code = code.replace(checklistFuncRe, newChecklistFunc);

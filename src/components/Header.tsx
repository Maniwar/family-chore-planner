          ...
          <div className="flex items-center space-x-3 shrink-0">
            ...
            <div className="shrink-0">
              <div className="flex items-center space-x-2">
                ...
                <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold ${theme.badgeBg} ${theme.badgeText} border ${theme.badgeBorder} whitespace-nowrap`}>
                  {t.momsCommand}
                </span>
              </div>
              <p className="text-[11px] sm:text-xs text-slate-500 whitespace-nowrap max-w-[220px] 2xl:max-w-xs truncate">
                {householdInfo.houseAddressOrMotto || t.appSubtitle}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 justify-end flex-nowrap">
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-colors shadow-2xs cursor-pointer"
            ...
            {isMomMode && pendingInspectionCount > 0 && (
              <button
                ...
                className="relative inline-flex items-center gap-1 px-2.5 py-1.5 rounded-xl text-xs font-extrabold bg-amber-500 text-white shadow-xs hover:bg-amber-600 transition-all animate-pulse cursor-pointer whitespace-nowrap"
            ...
            {isMomMode && (
              <button
                ...
                className={`inline-flex items-center gap-1 px-2.5 py-1.5 sm:px-3 rounded-xl text-xs font-bold ${theme.primaryBg} ${theme.primaryText} ${theme.primaryHover} transition-all shadow-xs cursor-pointer active:scale-95 whitespace-nowrap`}
              >

  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div 
        ...
        className="bg-white rounded-3xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-150 my-auto"
      >
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex-1 space-y-1.5">
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-white hover:bg-slate-100 text-slate-800 border border-slate-300 shadow-2xs transition-colors active:scale-95"
                  >
                  ...
                  {avatarPhotoUrl && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-2 rounded-xl text-xs font-semibold text-rose-600 hover:bg-rose-50 border border-rose-200 transition-colors active:scale-95"
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {emojiPresets.map((emoji) => (
                <button
                  ...
                  className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl text-base sm:text-lg flex items-center justify-center transition-all ${
                    avatarEmoji === emoji
                      ? 'bg-rose-100 border-2 border-rose-500 scale-105 shadow-xs'
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm p-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-rose-500 font-medium"
            />
          </div>

    ...
    <div className="space-y-4 pb-20 sm:pb-8">
      ...
      {activePersonSummary && (
        <div 
          ...
          onClick={() => setSelectedPersonSheet(null)}
        >
          <div
          ...
          >
            ...
            <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              ...
              <button
                onClick={() => setSelectedPersonSheet(null)}
                className="p-1.5 rounded-full bg-slate-200/80 text-slate-600 hover:bg-slate-300 transition-colors cursor-pointer min-h-[36px] min-w-[36px] flex items-center justify-center"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-4 sm:p-5 overflow-y-auto space-y-3 flex-1 pb-10 sm:pb-5">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                {isMomMode && activePersonSummary.overdueItems.length > 0 && (
                  <div className="flex items-center gap-1.5">
                    <button
                      onClick={() => handleOpenNudge(activePersonSummary.member)}
                          ...
                          >
                            ...
                            {isMomMode && (
                              <div className="pt-2 border-t border-slate-100 flex items-center gap-2">
                                <button
                                  onClick={() => {
                                    handleOpenNudge(item.member, item.chore);
                                  }}
